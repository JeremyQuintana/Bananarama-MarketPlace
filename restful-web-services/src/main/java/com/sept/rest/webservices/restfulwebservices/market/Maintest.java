...
import com.sept.rest.webservices.restfulwebservices.market.Database;
...
public class Maintest {
	...
	//	Database.search_by_category("Household"); 
		...
		String[][] arraynew={{"1", "Confetti", "Beautiful multicolored confetti. Used but like new.", "georgemichael99", "$20"},
