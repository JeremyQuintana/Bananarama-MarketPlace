...
class AccountComponent extends Component {
    ...
    render() {
      /*
      series of variables that holds the data of posts from frontend
      essentially gets all data before rendering them
      */
    ...
    //function to get the data of current user depending on item status
    refreshPosts(status) {
    ...
    //function to get the data list of chats to the user
    refreshChatHistory(){
